...
@Data
public class ReactiveMaintenanceModel extends PitagoraModel {

    public static ReactiveMaintenanceModel create() {
        return new ReactiveMaintenanceModel();
    }

    private ReactiveMaintenanceModel() {
        locked = true;
        ...
        Arrays.asList(
                        ...
                        ModelField.builder().name("segnalatoDa").description("Segnalato Da").type(FieldType.STRING).build(),
                        ModelField.builder().name("societa").description("Società").type(FieldType.STRING).build(),

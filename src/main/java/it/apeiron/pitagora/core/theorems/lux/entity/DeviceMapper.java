...
@NoArgsConstructor
@Data
public class DeviceMapper extends PitagoraMapper {

    public static DeviceMapper create(PitagoraModel model) {
        return new DeviceMapper(model);
    }

    private DeviceMapper(PitagoraModel model) {
        locked = true;
        name = ThmLuxEntity.DEVICE.pitagoraName();
